...
import com.dev.noteappkmm.domain.useCases.SearchNotes
...
class NoteListViewModel @Inject constructor(
    ...
    private val notes = savedStateHandle.getStateFlow(
        "notes",
        emptyList<Note>()
    )
    private val searchText = savedStateHandle.getStateFlow(
        "searchText",
        ""
    )
